...
var (
	// ErrParseFailed is returned when a pool failed to parse certificates.
	ErrParseFailed = errors.New("error when parsing certificates")
)
...
// CACerts builds an X.509 certificate pool containing the Mozilla CA Certificate bundle.
